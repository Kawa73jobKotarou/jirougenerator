    ...
    <body>
        ...
        <main>
            <section>
                ...
                <form name="fm" action="sample.py" method="post" enctype="multipart/form-data" accept=".jpg, .jpeg, .png, .JPEG">
...
try:
    ...
    origin_image_path = "img/origin_image.jpg"
    ...
    output_image_path = "img/generated_image.jpg"
